                    ...
                    <div className="md:col-span-1">
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:trilliondiamondtrilliondiamond@gmail.com" className="hover:text-primary transition-colors break-all text-sm">trilliondiamondtrilliondiamond@gmail.com</a>
                            </li>
                        </ul>
                    </div>
